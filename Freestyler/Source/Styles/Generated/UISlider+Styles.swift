...
public extension UISlider {
    ...
    public static func styleMinimumTrackTintColor(minimumTrackTintColor: Color?) -> Style {
    ...
    public static func styleMaximumTrackTintColor(maximumTrackTintColor: Color?) -> Style {
