...
public extension UISwitch {
    ...
    public static func onTintColor(onTintColor: ColorType?) -> Style {
    ...
    public static func thumbTintColor(thumbTintColor: ColorType?) -> Style {
    ...
    public static func onImage(onImage: UIImage?) -> Style {
    ...
    public static func offImage(offImage: UIImage?) -> Style {
