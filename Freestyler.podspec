#
#  Be sure to run `pod spec lint Freestyler.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Alexander Doloz"
  # s.authors            = { "Alexander Doloz" => "adoloz@f3code.com" }
  # s.social_media_url   = "http://twitter.com/Alexander Doloz"
...
#   s.platform     = :ios
  ...
  s.source       = { :git => "https://github.com/cayugasoft/Freestyler.git", :tag => "#{s.version}" }
  ...
  s.dependency "FreestylerCore", "~> 0.3.0"
